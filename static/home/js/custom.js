...
document.addEventListener('DOMContentLoaded', function () {
    // یافتن لینک درون منو
    const loginMenuLink = document.querySelector('header .login a');

    // بررسی محتوای متن لینک
    if (loginMenuLink && loginMenuLink.textContent.trim() === "پنل چت مدیریت") {
        // اضافه کردن کلاس به منوی والد
        const loginMenu = document.querySelector('header .login');
        if (loginMenu) {
            loginMenu.classList.add('logged-in');
        }
    }
});
